...
var _playvideo = require("./modules/playvideo");
var _initTabs = require("./modules/tabs/init-tabs");
var _initTrainersSlider = require("./modules/init-trainers-slider");
var _initReviewsSlider = require("./modules/init-reviews-slider");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _playvideo.playVideo)();
  (0, _initTabs.initTabs)();
  (0, _initTrainersSlider.initTrainersSlider)();
  (0, _initReviewsSlider.initReviewsSlider)();
  (0, _smoothScroll.initSmoothScroll)();
...
},{"./modules/form-validate/form":3,"./modules/init-reviews-slider":9,"./modules/init-trainers-slider":10,"./modules/playvideo":11,"./modules/smooth-scroll":12,"./modules/tabs/init-tabs":13,"./utils/ios-vh-fix":16}],2:[function(require,module,exports){
"use strict";
...
exports.initReviewsSlider = void 0;
...
exports.initReviewsSlider = initReviewsSlider;
...
exports.initTrainersSlider = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var initTrainersSlider = function initTrainersSlider() {
  var trainersSlider = document.querySelector('.trainers__slider');
  if (trainersSlider) {
    (function () {
      return new _swiper.default('.trainers__slider', {
        direction: 'horizontal',
        loop: true,
        navigation: {
...
exports.initTrainersSlider = initTrainersSlider;

},{"../vendor/swiper":17}],11:[function(require,module,exports){
"use strict";
...
var playVideo = function playVideo() {
  var buttonPlay = document.querySelector('.about__video-button');
  var videoFraim = document.querySelector('.about__video-frame');
  var onButtonPlayClick = function onButtonPlayClick() {
    var src = videoFraim.dataset.src;
